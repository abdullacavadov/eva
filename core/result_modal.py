"""VICTOR nəticələrini ayrıca modal pəncərədə göstərmək üçün UI köməkçisi."""
...
def show_result_modal(root: tk.Misc, context: ResultContext, selected_item: dict[str, Any] | None = None) -> tk.Toplevel:
    """Nəticəni əsas VICTOR layout-una toxunmadan modal pəncərədə göstərir."""
    window = tk.Toplevel(root)
    window.title("VICTOR — Nəticə")
    ...
    tk.Label(header, text="VICTOR", bg=bg, fg=accent, font=("Segoe UI", 14, "bold")).pack(side="left")
