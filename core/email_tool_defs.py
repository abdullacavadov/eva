EMAIL_TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            "Gmail mesajlarının dağıdıcı və həmişəlik silinməsi üçün əvvəlcə "
            "hədəfi müəyyən edir və istifadəçi təsdiqi tələb edən plan hazırlayır. "
            "Dəstəklənən scope-lar: drafts (bütün qaralamalar), draft (konkret draft), "
            "spam, trash, promotions və social. Bu alət özü heç nə silmir."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
    ...
    },
    {
        "name": "prepare_email_deletion",
        "description": (
            "Gmail email(lər)ini həmişəlik silmək üçün silmə planı hazırlayır. "
            "Bu alət heç bir emaili silmir və yalnız istifadəçidən açıq təsdiq tələb edən "
            "confirmation nəticəsi qaytarır. "
            "Yalnız bu scope-lar dəstəklənir: drafts, draft, spam, trash, promotions, social. "
            "draft scope-u üçün draft_id mütləq verilməlidir."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "scope": {
                    "type": "STRING",
                    "description": (
                        "Permanent delete scope-u: "
                        "drafts | draft | spam | trash | promotions | social"
                    ),
                },
                "draft_id": {
                    "type": "STRING",
                    "description": (
                        "Yalnız scope=draft olduqda konkret Gmail draft ID."
                    ),
                },
            },
            "required": ["scope"],
    ...
    },
    {
        "name": "delete_email",
        "description": (
            "İstifadəçi prepare_email_deletion nəticəsində təqdim olunan permanent-delete "
            "əməliyyatını açıq şəkildə təsdiqlədikdən sonra icra edir. "
            "Yalnız confirmation_id qəbul edir və email(lər)i Gmail-dan həmişəlik silir. "
            "Yeni scope və ya yeni target müəyyənləşdirmir."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "confirmation_id": {
                    "type": "STRING",
                    "description": (
                        "prepare_email_deletion nəticəsində qaytarılan "
                        "confirmation ID."
                    ),
                },
            },
