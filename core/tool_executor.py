...
class ToolExecutor:
    ...
    def result_looks_like_error(result) -> bool:
        ...
        if not text:
            return False
        error_markers = (
            "hata", "error", "xəta", "alinamadi", "alınamadı", "bulunamadi",
            "bulunamadı", "acilamadi", "açılamadı", "tamamlanamadi",
            "tamamlanamadı", "gecersiz", "geçersiz", "izin gerekiyor",
            "izin gerekli", "baglanti", "bağlantı", "gerekli.", "mümkün olmadı",
        )
