  ...
  return (
    ...
    >
      ...
      <div
        className="orb-beam"
        style={{
          background: `linear-gradient(transparent, ${withAlpha(color, '0.62')}, transparent)`,
          boxShadow: `0 0 30px 5px ${softGlow}`,
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          boxShadow: `0 0 22px ${softGlow}, inset 0 0 22px ${softGlow}`,
        }}
      >
