...
def test_update_contact_is_dispatched_with_resource_name():
    ...
    fc = SimpleNamespace(
        id="contact-update-1",
        name="update_contact",
        args={"resource_name": "people/c123", "display_name": "Updated", "phone_number": "+994559041494"},
    )
...
def test_structured_action_result_is_saved_and_can_be_selected():
    ...
    structured = {
        "type": "calendar_event",
        "status": "success",
        "query": {"query": "2026-08-20"},
        "data": [
            {"id": "calendar_event:e1", "summary": "Dentist", "google_event_id": "e1"},
            {"id": "calendar_event:e2", "summary": "Meeting", "google_event_id": "e2"},
        ],
        "count": 2,
        "selected": None,
        "meta": {},
